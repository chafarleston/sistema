<?php
    ...
    class Configuration extends ModelTenant
    {
        protected $fillable = [
            ...
            'legend_footer_sale',
            'enabled_search_second_name_items',
        ];
        ...
        protected $casts = [
            ...
            'enabled_search_second_name_items' => 'bool',
        ];
        ...
        public function getCollectionData()
        {
            ...
            return [
                ...
                'enabled_search_second_name_items' => $this->enabled_search_second_name_items,
            ];
        }
        ...
        public function isSearchSecondNameItems(): ?bool
        {
            return (bool)$this->enabled_search_second_name_items;
        }
