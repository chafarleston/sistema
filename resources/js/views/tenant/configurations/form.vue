                ...
                <el-tabs v-model="activeName" type="border-card" class="rounded">
                    ...
                    <el-tab-pane class="mb-3" name="second">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-4">
                                <label class="control-label">
                                    Activar búsqueda de productos por nombre secundario
                                    <el-tooltip class="item"
                                        content="Al activar esta función el rendimiento de busqueda puede disminuir"
                                        effect="dark" placement="top-start">
                                        <i class="fa fa-info-circle"></i>
                                    </el-tooltip>
                                </label>
                                <div :class="{ 'has-danger': errors.enabled_search_second_name_items }" class="form-group">
                                    <el-switch v-model="form.enabled_search_second_name_items" active-text="Si"
                                        inactive-text="No" @change="submit"></el-switch>
                                    <small v-if="errors.enabled_search_second_name_items" class="invalid-feedback"
                                        v-text="errors.enabled_search_second_name_items[0]"></small>
                                </div>
                            </div>
                        </div>
                    </el-tab-pane>
