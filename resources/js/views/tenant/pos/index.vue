                    ...
                    <template v-for="(item, index) in items">
                      ...
                      <el-button slot="reference"><i class="fa fa-search"></i></el-button>
                                    ...
                                    <p
                                        ...
                                        "
                                        class="font-weight-semibold mb-0 text-center"
                                    >
                                        {{ item.description }}
                                    </p>
                                    <p
                                ...
                                <div
                                    class="card-footer pointer text-center bg-white"
                                >
    ...
    methods: {
        ...
        async clickPayment() {
            ...
            let existError = this.form.items.some(item => {
                ...
                if (
                    unit_type_notAllowed.includes(item.unit_type_id) &&
            ...
            if (existError) {
                ...
                if (errorFloatQuantity) {
                    this.$message.error(
                        "El producto con ese tipo de unidad no permite cantidad en decimales"
                    );
                }
