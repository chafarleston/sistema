...
export default {
    ...
    methods: {
        ...
        getQueryParameters() {
            ...
            let document_type_id = JSON.stringify(this.form.document_type_id)

            return `${parameters}&user_id=${JSON.stringify(this.form.user_id)}&document_type_id=${document_type_id.toLowerCase() !== 'null' ? document_type_id : ''}`
