                  ...
                  <div class="row mt-4">
                    <div class="col-md-6 mb-4">
                      ...
                      <div :class="{'has-danger': errors.enabled_environment_1}"
                        ...
                        <br><br>
                        <label class="control-label">Cantidad de mesas <b>{{ form.tables_quantity }}</b></label>
                        <el-slider
                    ...
                    <div class="col-md-6 mb-4">
                      ...
                      <div :class="{'has-danger': errors.enabled_environment_2}"
                        ...
                        <br><br>
                        <label class="control-label">Cantidad de mesas <b>{{ form.tables_quantity_environment_2 }}</b></label>
                        <el-slider
                    ...
                    <div class="col-md-6 mb-4">
                      ...
                      <div :class="{'has-danger': errors.enabled_environment_3}"
                        ...
                        <br><br>
                        <label class="control-label">Cantidad de mesas <b>{{ form.tables_quantity_environment_3 }}</b></label>
                        <el-slider
                    ...
                    <div class="col-md-6 mb-4">
                      ...
                      <div :class="{'has-danger': errors.enabled_environment_4}"
                        ...
                        <br><br>
                        <label class="control-label">Cantidad de mesas <b>{{ form.tables_quantity_environment_4 }}</b></label>
                        <el-slider
